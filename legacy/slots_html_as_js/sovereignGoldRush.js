...
<title>Golden Vault — Sovereign Gold Rush</title>
...
<div class="slot-header">
  <h1 class="slot-title">Sovereign Gold Rush</h1>

  <div style="display:flex">
    <div class="metric">BALANCE: <span id="balance">0</span> GOLD</div>
    <div class="metric">BET: <span id="bet">150</span> GOLD</div>
  </div>
</div>
...
<div class="controls">
  <button onclick="spinSovereignGoldRush()">SPIN</button>
...
<!-- MACHINE -->
<script src="/games/slots/sovereignGoldRush.js"></script>
