    ...
    <VaultShell>
      <section className="relative px-6 md:px-10 pt-12 pb-16">
        ...
        <div className="max-w-xl mx-auto rounded-3xl border border-white/10 bg-black/35 backdrop-blur-md p-8 shadow-vv-soft">
          <div className="text-xs tracking-[0.35em] uppercase text-white/55">Member Login</div>
          <h1 className="mt-4 text-3xl font-semibold">Return to the Lounge</h1>
          <p className="mt-4 text-white/70">Firebase auth UI plugs in here (email/password or magic link).</p>
          <div className="mt-8 flex gap-3">
            <LuxeButton href="/members" label="Enter (Demo)" variant="gold" />
