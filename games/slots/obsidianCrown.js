...
<title>Golden Vault — Obsidian Crown</title>
...
<div class="slot-header">
  <h1 class="slot-title">Obsidian Crown</h1>

  <div style="display:flex">
    <div class="metric">BALANCE: <span id="balance">0</span> GOLD</div>
    <div class="metric">BET: <span id="bet">200</span> GOLD</div>
  </div>
</div>
...
<div class="controls">
  <button onclick="spinObsidianCrown()">SPIN</button>
...
<!-- MACHINE -->
<script src="/games/slots/obsidianCrown.js"></script>
