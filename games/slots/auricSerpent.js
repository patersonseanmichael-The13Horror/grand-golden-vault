...
<title>Golden Vault — Auric Serpent</title>
...
<div class="slot-header">
  <h1 class="slot-title">Auric Serpent</h1>

  <div style="display:flex">
    <div class="metric">BALANCE: <span id="balance">0</span> GOLD</div>
    <div class="metric">BET: <span id="bet">175</span> GOLD</div>
  </div>
</div>
...
<div class="controls">
  <button onclick="spinAuricSerpent()">SPIN</button>
...
<!-- MACHINE -->
<script src="/games/slots/auricSerpent.js"></script>
